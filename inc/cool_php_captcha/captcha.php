...
class SimpleCaptcha {
     ...
     * @return string Word
     */
    private function GetDictionaryCaptchaText($delimeter = "\n", $minLength = 5, $maxLength = 8) 
	{
		...
		$randomKey  = mt_rand(1, $wordsCount);

		$word       = mb_substr($words[$randomKey], 0, $maxLength);
		
		if(strlen($word) < 5) {
			$word = $word . $this->randomStr(3);
		}
		
		return $word;
    }
	
	private function randomStr($length = 10, $characters = 'abcdefghijklmnopqrstuvwxyz')
	{
		$output = null;
