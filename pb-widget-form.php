...
class #Widget_Paperboot_Form# extends WP_Widget
{
	/*
	...
	*/
	...
	{
		$this->title = __('#widget_title#', 'text_domain');
		
		parent::__construct(
			'#widget_id#', 
			__('#widget_name#'), 
			array(
				'description' => __('#widget_description#', 'text_domain'),
	...
	*/
	public function form($instance)
	{
		...
		<div class="pb-widget-form" id="#post_type#">
			...
			<div class="message-save message-error"> 
				<p><strong><?php _e('There are no form fields created.', 'text_domain') ?></strong>
					<a href="/wp-admin/post.php?post=#post_id#&action=edit">Create fields</a>
				</p>
			</div>
			<?php endif ?>
	...
	*/
	public function widget($current, $previous)
	{
		...
		$settings = Paper_Boot_Form::get_pb_settings('#post_type#');
